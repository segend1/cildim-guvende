...
const INGREDIENT_RISKS: Record<string, SafetyRating> = {
    ...
    'dmdm hydantoin': { risk: 'high', origin: 'synthetic', description: 'Zamanla formaldehit serbest bırakan koruyucu. Alerji ve tahriş riski.' },
    'imidazolidinyl urea': { risk: 'high', origin: 'synthetic', description: 'Formaldehit salıcı. Egzama ve kontakt dermatit tetikleyicisi.' },
    'diazolidinyl urea': { risk: 'high', origin: 'synthetic', description: 'Formaldehit salıcı. Hassas ciltler için yüksek risk.' },
    'phthalate': { risk: 'high', origin: 'synthetic', description: 'Plastikleştirici. Üreme sistemi toksisitesi riski taşır.' },
    'hydroquinone': { risk: 'high', origin: 'synthetic', description: 'Cilt beyazlatıcı. Hücre toksisitesi nedeniyle AB\'de yasaklanmıştır.' },
    'methylisothiazolinone': { risk: 'high', origin: 'synthetic', description: 'MIT. Çok güçlü bir temas alerjenidir. Durulanan ürünlerde bile riskli.' },
    ...
    'butylphenyl methylpropional': { risk: 'high', origin: 'synthetic', description: 'Lilial. Üreme sağlığına zararlı olduğu için yasaklanma sürecindedir.' },
    'bha': { risk: 'high', origin: 'synthetic', description: 'Hormon bozucu şüphesi olan antioksidan koruyucu.' },
    'coal tar': { risk: 'high', origin: 'synthetic', description: 'Kömür katranı. Saç boyalarında bulunur, kanserojen riski vardır.' },
    'per- and polyfluoroalkyl substances': { risk: 'high', origin: 'synthetic', description: 'PFAS ("Sonsuz kimyasallar"). Vücutta birikim yapabilir (İnsan sağlığı riski).' },

    // MODERATE RISK (Sarı Listesi - Dikkat)
    'bht': { risk: 'moderate', origin: 'synthetic', description: 'BHA alternatifi. Düşük dozda güvenli sayılsa da birikim riski tartışmalı.' },
    ...
    'parfum': { risk: 'moderate', origin: 'synthetic', description: 'Bilinmeyen koku bileşenleri. Kontakt dermatit riski.' },
    ...
    'talc': { risk: 'moderate', origin: 'natural', description: 'Talk minerali. Asbestten iyi arındırılmamışsa risklidir. Solunmamalı.' },
    ...
    'peg': { risk: 'moderate', origin: 'synthetic', description: 'Polietilen Glikol. 1,4-dioxane kirliliği riski taşır. İnsan sağlığı için limitli kullanımı önerilir.' },
    'ceteareth-20': { risk: 'moderate', origin: 'synthetic', description: 'Emülgatör. 1,4-dioxane ve etilen oksit kalıntı riski taşıyabilir.' },
    ...
    // NEWLY ADDED COMMON INGREDIENTS
    ...
    'peg-100 stearate': { risk: 'moderate', origin: 'synthetic', description: 'PEG türevi yumuşatıcı. 1,4-dioxane kirliliği riski taşır.' },
    ...
    'polysorbate 20': { risk: 'moderate', origin: 'synthetic', description: 'Emülgatör. Kirlilik riski (Etilen oksit) taşıyabilir.' },
    'polysorbate 60': { risk: 'moderate', origin: 'synthetic', description: 'Emülgatör. Kirlilik riski taşıyabilir.' },
    ...
    'cocamidopropyl betaine': { risk: 'moderate', origin: 'synthetic', description: 'Köpürtücü. Safsızlık varsa alerji riski olabilir.' },
